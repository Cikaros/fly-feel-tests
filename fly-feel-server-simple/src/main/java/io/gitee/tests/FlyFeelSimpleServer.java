...
public class FlyFeelSimpleServer {
    ...
    @GetMapping("/index")
    @ResponseBody
    public RestResult index2(@RequestParam Map<String, Object> param) throws InterruptedException {
        Thread.sleep(1000);
        return RestResult.newInstance(HttpStatus.INTERNAL_SERVER_ERROR, param);
    }
